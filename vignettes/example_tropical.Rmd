...
lactin2_95 7 times, logna6_76 4 times, lactin1_95 4 times, briere1_99 4 times, 
damos_08 4 times, analytis_77 3 tiems, taylor_81 2 times, and so on (this may 
...
this time, so that we have to find a closely related species.
...
Here we can see for example that _Symmetrischema tangolias_ study by Sporleder 
et al. 2016 has used the taylor_81 model, and that _Phthorimaea operculella_ 
...
if we want to have a first look on the taylor_81 or briere1_99 models.
...
(e.g., determination of a thermal metric), the taylor_81 or lactin1_95 models 
can be used as candidate models.

## Fitting models to empirical datasets

Now that we have model candidates and starting parameter estimates from a 
