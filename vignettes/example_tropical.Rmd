...
The resulting dataset looks like the following table (for eggs development), 
...
results to create vectors and data frames.
...
Now that we have model candidates and starting parameter estimates from 
