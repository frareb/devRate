...
test_that("devRateQlStat 1 df 3 nls", {
  dfList <- list(data.frame(T = seq(from = 0, to = 50, by = 10),
                            rT = c(0.001, 0.008, 0.02, 0.03, 0.018, 0.004)))
  fitList <- list(devRateModel(eq = janisch_32, temp = dfList[[1]][, 1], devRate = dfList[[1]][, 2],
                               startValues = list(Dmin = 5, Topt = 30, aa = 0.2, bb = 0.1)),
                  devRateModel(eq = kontodimas_04, temp = dfList[[1]][, 1], devRate = dfList[[1]][, 2],
                               startValues = list(aa = 1, Tmin = 7, Tmax = 40), algo = "LM"),
                  devRateModel(eq = poly2, temp = dfList[[1]][, 1], devRate = dfList[[1]][, 2],
...
test_that("devRateQlStat df no list", {
  dfList <- data.frame(T = seq(from = 0, to = 50, by = 10),
                       rT = c(0.001, 0.008, 0.02, 0.03, 0.018, 0.004))
  fitList <- list(devRateModel(eq = janisch_32, temp = dfList[, 1], devRate = dfList[, 2],
                               startValues = list(Dmin = 5, Topt = 30, aa = 0.2, bb = 0.1)),
                  devRateModel(eq = kontodimas_04, temp = dfList[, 1], devRate = dfList[, 2],
                               startValues = list(aa = 1, Tmin = 7, Tmax = 40), algo = "LM"),
                  devRateModel(eq = poly2, temp = dfList[, 1], devRate = dfList[, 2],
                               startValues = list(a0 = 1, a1 = 1, a2 = 1), algo = "LM"))
  qlStat <- devRateQlStat(eq = list(janisch_32, kontodimas_04, poly2), nlsDR = fitList, df = dfList)
...
test_that("devRateQlStat nls no list", {
  dfList <- list(data.frame(T = seq(from = 0, to = 50, by = 10),
                            rT = c(0.001, 0.008, 0.02, 0.03, 0.018, 0.004)))
  fitList <- devRateModel(eq = janisch_32, temp = dfList[[1]][, 1], devRate = dfList[[1]][, 2],
                          startValues = list(Dmin = 5, Topt = 30, aa = 0.2, bb = 0.1))
...
test_that("devRateQlStat eq stinner ou lamb", {
  dfList <- list(data.frame(T = seq(from = 0, to = 50, by = 10),
                            rT = c(0.001, 0.008, 0.02, 0.03, 0.018, 0.004)))
  fitList <- devRateModel(eq = janisch_32, temp = dfList[[1]][, 1], devRate = dfList[[1]][, 2],
                          startValues = list(Dmin = 5, Topt = 30, aa = 0.2, bb = 0.1))
